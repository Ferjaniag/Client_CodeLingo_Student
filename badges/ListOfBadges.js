...
import axios from "axios"; // Import axios if not done already
  ...
  useEffect(() => {
    const loadBadges = async () => {
      ...
      try {
        ...
        const badgeDetailsPromises = userBadges.map((badge) => fetchBadgeDetails(badge.badgeId)); // Fetch badge details
      ...
      <ScrollView contentContainerStyle={styles.badgeList}>
        {badges.map((badge, index) => (
          <View key={index} style={styles.badgeContainer}>
            <Image source={require("../assets/silver-badge.png")} style={styles.badgeImage} />
